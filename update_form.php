...
$publish_status = (int)$result['publish_stauts'];
?>
...
<body>
    <h2>ブログ更新フォーム</h2>
    <form action="/blog_app/blog_update.php" method="POST">
        ...
        <br>
        <input type="radio" name="publish_status" value="1"  <?php if($publish_status ===  1) echo "checked" ?> checked>公開
